...
model = ModelData()
model:setName("dalek_saucer")
model:setMesh("saucer.obj")
model:setTexture("ammo_box.png")
model:setSpecular("ammo_box_specular.png")
model:setIllumination("ammo_box_illumination.png")
model:setRenderOffset(0, 0, 5)
...
model = ModelData()
model:setName("dalek_saucer_large")
model:setMesh("saucer.obj")
model:setTexture("ammo_box.png")
model:setSpecular("ammo_box_specular.png")
model:setIllumination("ammo_box_illumination.png")
...
model = ModelData()
model:setName("tardis")
model:setMesh("tardis.obj")
model:setTexture("tardis.png")
model:setSpecular("ammo_box_specular.png")
model:setIllumination("ammo_box_illumination.png")
model:setRenderOffset(0, 0, 0)
model:setScale(20)
