...
Dalek = FactionInfo():setName("Daleks")
Dalek:setGMColor(255, 0, 0)
Dalek:setDescription([[The Daleks were a warrior race made up of genetically engineered mutants belonging to fundamental DNA type 467-989 who were originally from the planet Skaro. The mutants were usually encased inside armour consisting of polycarbide and the metal Dalekanium.]])
Dalek:setEnemy(human)
Dalek:setEnemy(exuari)
Dalek:setEnemy(kraylor)
